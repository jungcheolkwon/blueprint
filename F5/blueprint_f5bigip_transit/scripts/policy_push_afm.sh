...
#curl -sk -H "Content-Type: test/x-yaml" -H "X-F5-Auth-Token: $token2" -X POST --data-binary @$dir/blueprint_f5bigip_transit/scripts/afm.json https://$ip:9443/mgmt/shared/appsvcs/declare | jq -r .
#echo -e "\033[32m ---------------------\033[0m "
